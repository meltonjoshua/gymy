...
export default function BodyStatsPage() {
  ...
  const handleSubmit = (measurement: Omit<ExtendedBodyMeasurement, 'id'>) => {
            ...
            {latestMeasurement.bodyFatPercentage != null && (
              <div className="bg-gray-800/60 border border-gray-700/50 rounded-xl p-3">
                ...
                <div className="text-xl font-bold text-orange-400">
                  {latestMeasurement.bodyFatPercentage} <span className="text-xs font-normal">%</span>
                </div>
                {trends.length > 1 && trends[1]?.change !== null && trends[1]?.change !== undefined && (
                  <div
                ...
                >
                  <div className="flex-1">
                    <div className="flex items-center gap-3">
                      ...
                      {s.bodyFatPercentage != null && (
                        <span className="text-sm text-orange-400 font-semibold">{s.bodyFatPercentage}%</span>
                      )}
                    </div>
